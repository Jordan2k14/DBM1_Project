...
sql_insert_publisher = "INSERT INTO publisher (id,publisher_name) VALUES(%s,%s)"

#list of games (With Their attributes values)
#None here means value will be missing in the table
publisher_List=[(1,'10TACLE Studios'),
(2,'1C Company'),
...
try:
    ...
    cursor.executemany(sql_insert_publisher,publisher_List)
    ...
    sql_select_query = """ SELECT * FROM publisher  """
